...
# V4.1 指数池（docs/v4-best-plan.md §3，2026-09-22）：相对 BROAD_INDEX_POOL
# +上证指数/深证成指，−红利指数/国证2000。000001.SH/399001.SZ 日线由
# work/collect_v41_qlib.py 从本地 qlib 链路补采（iFinD 月度配额 -4318 时的
# 替代链路，4 指数交叉验证偏移一致、偏差 ≤0.9bp）。两代码无 5min 数据
# （HF 配额/覆盖受限）——分钟重排在它们为领先指数的信号日回退日线排序。
V41_BROAD_POOL = {
    "883957.TI": "同花顺全A",
    "000001.SH": "上证指数",
    "399001.SZ": "深证成指",
