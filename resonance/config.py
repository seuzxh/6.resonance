...
# −红利指数/国证2000）。**2026-09-22 用户指令调整**（docs/v41-pool-adjustment.md）：
# 删 上证50/深证成指/中证2000/科创综指，增 大盘股 883417.TI → 现 10 池。
# 883417.TI 日线/5min 暂无本地源（iFinD 配额 -4318，约 2026-10-01 恢复后
# 由 work/collect_v41.py 补采；qlib/本地各库均无 883 段指数）——数据未到位
# 期间引擎会显式告警并按可用子集运行（过渡 9 池口径，结果须带此标注）。
V41_BROAD_POOL = {
    "883957.TI": "同花顺全A",
    "000001.SH": "上证指数",
    "883417.TI": "大盘股",
