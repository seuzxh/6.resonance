...
- [x] 2026-09-22 **指数池调整**（用户指令）：删上证50/深证成指/中证2000/
      科创综指、增大盘股 883417.TI（13→10 池）。883417 暂无本地源（配额
      -4318），9 池过渡口径 10bp 中位 +4.78%/−25.37% vs 13 池 +53.39%/−23.07%
      ——显著负效且损伤集中 2026 段；883417 到位后重跑定案。见
